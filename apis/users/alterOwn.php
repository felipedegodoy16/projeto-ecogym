<?php 
  ...
  $name = trim($datas['update-name']);
  $cpf = trim($datas['update-cpf']);
  $email = trim($datas['update-email']);
  ...
  $cep = trim($datas['update-cep']);
  $state = trim($datas['update-state']);
  $city = trim($datas['update-city']);
  $neighborhood = trim($datas['update-bairro']);
  $street = trim($datas['update-street']);
  $number = trim($datas['update-number']);
