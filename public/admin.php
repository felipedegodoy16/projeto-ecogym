<?php 
  require_once __DIR__ . '/../apis/files/logged_admin.php';
?>
...
<body>
  <main id="admin">
    <div class="header-sidenav">
      <div id="div-hamburguer-sidenav" class="div-hamburguer-sidenav">
        <span id="icon-hamburguer-sidenav" class="icon-hamburguer-sidenav"></span>
      </div>
    </div>
    <nav class="side-nav-admin font-1-xs cor-6" id="sidenav-links">
      <ul>
